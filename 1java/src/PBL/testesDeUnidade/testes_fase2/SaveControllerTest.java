...
import PBL.model.repository.MapaRepository;
...
public class SaveControllerTest {
    ...
    public void test_Fluxo_Completo_Criar_E_Carregar_Jogo() throws JogoException {
        ...
        MapaRepository mapaR = new MapaRepository();
        ...
        jogoCriado.getJogador().setLocalizacao(controller.getMapa().buscarLocalPorNome("Biblioteca"));
